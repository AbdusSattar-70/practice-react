...
## 📖 practice-react <a name="about-project"></a>

<h5> I set up the environment and tools needed to develop a React application. In this project, I have made a simple SPA To-Do-App project that allows user to add and remove To Do and display on UI .</h5>
...
```bash
       git clone https://github.com/AbdusSattar-70/practice-react.git
       cd practice-react
```
